  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved treatment as @treatment" do
        post :create, {:treatment => invalid_attributes}, valid_session
        expect(assigns(:treatment)).to be_a_new(Treatment)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested treatment" do
        treatment = Treatment.create! valid_attributes
        put :update, {:id => treatment.to_param, :treatment => new_attributes}, valid_session
        treatment.reload
    ...
    context "with invalid params" do
      it "assigns the treatment as @treatment" do
        treatment = Treatment.create! valid_attributes
        put :update, {:id => treatment.to_param, :treatment => invalid_attributes}, valid_session
        expect(assigns(:treatment)).to eq(treatment)
      end
